...
-- Schema db_blog_pessoal
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_blog_pessoal` DEFAULT CHARACTER SET utf8 COLLATE utf8_czech_ci ;
USE `db_blog_pessoal` ;
...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_temas` (
  `id` BIGINT NOT NULL,
  `col` VARCHAR(255) CHARACTER SET 'armscii8' COLLATE 'armscii8_bin' NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
